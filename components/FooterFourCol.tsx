    ...
    <footer className={styles.footer}>
        <div className="container">
            <div className={styles.top}>
                <div className={styles.logo}>FourColLogo</div>
                <div className={styles.menus}>
                    ...
                    <div className={styles.menu}><h4>Menu 4</h4><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div>
                </div>
            </div>
